...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sb', builtin.git_files, { desc = '[S]earch git [B]ranch' })
  ...
  },
  {
    ...
    config = function()
      require('nvim-tree').setup {
        ...
        vim.keymap.set('n', '<leader>e', '<cmd>NvimTreeFocus<CR>', { desc = 'Toggle File [E]xplorer' }),
      }
    end,
  },
  {
    'mrjones2014/smart-splits.nvim',
    lazy = false, -- load it immediately so it works consistently
    keys = {
      {
        '<C-h>',
        function()
